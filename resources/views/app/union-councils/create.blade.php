...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">{{ $title ?? 'Create Union Council'}}</h5>
            <a href="{{ route('app.union-councils.index') }}" class="btn btn-secondary">Back to List</a>
        </div>

        <div class="card-body">
            <form action="{{ route('app.union-councils.store') }}" method="POST" id="createUnionCouncilForm">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">Create Union Council</button>
