...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('app.officers.update', Crypt::encrypt($model->id)) }}" method="POST" id="editOfficerForm">
            @csrf
            @method('PUT')
    ...
    <div class="card-footer text-end">
        ...
        <button type="submit" form="editOfficerForm" class="btn btn-primary">
            Update Officer
        </button>
